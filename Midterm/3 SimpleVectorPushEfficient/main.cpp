 ...
 * Created on October 13, 2017, 4:31 PM
...
int main(int argc, char** argv) {
    ...
    //else cout<<"The following 2 Objects are not the Same!"<<endl;
    //cout<<"One of the Objects"<<a;
    //cout<<"Copy of the above Object"<<b;
    
    //Test an object by populating the simple vector and print
    SimpleVector<Object> svp(a);
    //cout<<"Simple Vector Object max Size = "<<svp.mxSize()<<svp[svp.size()-1];
    //Push an Object and printout the last object
    //svp.push(b);
    //cout<<"Simple Vector Push   max Size = "<<svp.mxSize()<<svp[svp.size()-1];
    ...
    cout<<"The Max Size and Size = "
            <<svi.mxSize()<<" "<<svi.size()<<endl<<svi[svi.size()-2]
                                         <<svi[svi.size()-1];
    */
    //Exit
    return 0;
